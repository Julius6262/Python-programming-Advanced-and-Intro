...
window.blit(robot, (640-width, 480-height))  # Right Bottom Corner
window.blit(robot, (640-width, 0))  # Right top corner
window.blit(robot, (0,0))  # left top corner
window.blit(robot, (0, 480-height))  #left Bottom Corner
pygame.display.flip()
