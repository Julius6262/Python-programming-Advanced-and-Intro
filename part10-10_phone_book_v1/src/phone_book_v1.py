...
class PhoneBook:
    ...
    def get_name(self, target_number: str):
        for name, phone_numbers in self.__persons.items():
...
class PhoneBookApplication:
    ...
    def search(self):  # Search for name
        name = input("name: ")
    ...
    def search_for_number(self):  # Search for number
        target_number = input("number:")
        name = self.__phonebook.get_name(target_number)
        if name == None:
